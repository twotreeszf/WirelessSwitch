...
#include "NptTransferStatusHandler.h"
...
protected:
    ...
    virtual NPT_Result SetupResponse(NPT_HttpRequest&              request, 
                                     ...
                                     NPT_TransferStatusHandler*&   status_handler) = 0;
...
private:
    ...
    virtual NPT_Result Write(NPT_HttpResponse*              response, 
                             ...
                             NPT_TransferStatusHandler*     status_handler  = NULL);
...
protected:
    ...
    NPT_Result SetupResponse(NPT_HttpRequest&              request, 
                             ...
                             NPT_HttpResponse&             response,
                             NPT_TransferStatusHandler*&   status_handler) {
        return m_Handler->SetupResponse(request, context, response, status_handler);
    }
