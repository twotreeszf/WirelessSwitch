...
public:
    ...
    NPT_Result Search(const NPT_HttpUrl& url = PLT_SsdpAddrConfig::Instance()->GetSsdpGroupUrl(), 
    ...
    NPT_Result Discover(const NPT_HttpUrl& url = PLT_SsdpAddrConfig::Instance()->GetSsdpGroupUrl(),
    ...
    NPT_Result InvokeAcitonDirectly(PLT_ActionReference& action, NPT_UInt32 timeoutSec);
    ...
    virtual NPT_Result SetupResponse(NPT_HttpRequest&              request,
                                     ...
                                     NPT_TransferStatusHandler*&   status_handler);
...
protected:
    ...
    NPT_Result   ProcessActionResponse(NPT_Result                    res,
                                       ...
                                       PLT_ActionReference&          action,
                                       void*                         userdata);
    NPT_Result   ProcessActionResponseDirectly(NPT_HttpResponse* response, PLT_ActionReference& action);
