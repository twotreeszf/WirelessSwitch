...
#define PLT_HTTP_DEFAULT_USER_AGENT "UPnP/1.0 DLNADOC/" PLT_PLATINUM_SDK_VERSION_STRING
#endif

#if !defined(PLT_HTTP_DEFAULT_SERVER)
#define PLT_HTTP_DEFAULT_SERVER "UPnP/1.0 DLNADOC/" PLT_PLATINUM_SDK_VERSION_STRING
#endif
...
public:
    ...
    NPT_Result SetupResponse(NPT_HttpRequest&              request, 
        ...
        return m_Delegate->SetupResponse(request, context, response, status_handler);
    }
